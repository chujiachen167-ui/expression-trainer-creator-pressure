(function (root, factory) {
  ...
  const defaults = {
    ...
    repeat: 4, gap: 38, displayMode: 'stream', cycleMs: 3000, swapTrigger: 'hover',
  ...
  function normalize(incoming = {}) {
    ...
    if (!['hover', 'blink'].includes(settings.swapTrigger)) settings.swapTrigger = defaults.swapTrigger;
